...
@section('title')
    {{!isset($arrozalesimagen->id) ? 'Agregar Imagen' : 'Editar Imagen'}}
@endsection
@section('content')
    <div class="content">
        <div class="row">
                    ...
                    <div class="card card-nav-tabs">
                        <div class="card-header card-header-tabs nav-pills-primary">
                            <h4 class="card-title m-2">
                                {!! $arrozalesimagen->id ? 'Editar Imagen' : 'Añadir Imagen' !!}
                            </h4>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer text-right">
                            <button type="submit"
                                    class="btn btn-primary">{{$arrozalesimagen->exists ? 'Guardar' : 'Crear'}}</button>
                        </div>
                    </div>
                </form>
            </div>
