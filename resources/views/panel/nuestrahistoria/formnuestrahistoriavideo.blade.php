...
@section('title')
    {{!isset($nuestrahistoriavideo->id) ? 'Agregar Video' : 'Editar Video'}}
@endsection
@section('content')
    <div class="content">
        <div class="row">
                    ...
                    <div class="card card-nav-tabs">
                        <div class="card-header card-header-tabs nav-pills-primary">
                            <h4 class="card-title m-2">
                                {!! $nuestrahistoriavideo->id ? 'Editar Video' : 'Añadir Video' !!}
                            </h4>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer text-right">
                            <button type="submit"
                                    class="btn btn-primary">{{$nuestrahistoriavideo->exists ? 'Guardar' : 'Crear'}}</button>
                        </div>
                    </div>
                </form>
            </div>
